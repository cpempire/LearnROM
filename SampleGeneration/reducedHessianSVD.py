...
class PreconditionedReducedHessianSVD:

    def __init__(self, pde, qoi, prior, tol):
        self.pde = pde
        self.qoi = qoi
        self.prior = prior
        self.rhs_fwd = pde.generate_state()
        ...
        self.mhelp = pde.generate_parameter()
        self.Hmhat1 = pde.generate_parameter()
        self.CHmhat1 = pde.generate_parameter()
        self.tol = tol
    # implement init_vector for Hessian in doublePassG
    def init_vector(self, m, dim):
        self.pde.init_parameter(m)
    ...
    def mult(self, mhat1, CHmat1):
        ...
        self.pde.apply_ij(PARAMETER,STATE, xhat, self.mhelp)
        self.Hmhat1.axpy(1., self.mhelp)
        self.prior.Rsolver.mult(self.Hmhat1, self.CHmhat1)
    ...
    def HessianInner(self, mhat1, mhat2):
        ...
        return mhat2.inner(self.CHmhat1), xhat, yhat


class ReducedHessianAverageSVD:
...
class PreconditionedReducedHessianAverageSVD:
    ...
    def __init__(self, pde, qoi, prior,tol, samples=None):
        ...
        self.mhelp = pde[0].generate_parameter()
        self.Hmhat1 = pde[0].generate_parameter()
        self.CHmhat1 = pde[0].generate_parameter()
        self.tol = tol
